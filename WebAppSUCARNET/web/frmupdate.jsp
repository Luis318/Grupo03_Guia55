<%-- 
    Document   : frmupdate.jsp
    Created on : 23/10/2021, 04:51:46 PM
    Author     : kevin
--%>
                ...
                <div class="card-body">
                    <form action="update.jsp?id=<%=id%>" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="autor" id="autor" value="<%=autor%>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="editorial" id="editorial" value="<%=editorial%>" required>
                            </div>
                        </div>
                        <a href="index.jsp" name="enviar" class="btn btn-danger" style="float: left">Cancelar</a>
                        <button type="submit" name="enviar" class="btn btn-primary" style="float: right">Actualizar</button>
                    </form>  
                </div>
            </div>
        </div>
